...
export default async function HistoryPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="title-manga text-5xl mb-6">MY HISTORY</h1>
        ...
        {history?.map((h: any) => {
          ...
          return (
            <Link key={h.id} href={`/manga/${manga.id}`}>
              <div className="card-manga p-4 cursor-pointer">
                <div className="flex items-center justify-between mb-3">
                  <h2 className="font-black text-lg">{manga.title}</h2>
                  <div className="flex gap-2">
                    <span className="badge-manga">{h.panel_order}コマ目を投稿</span>
                ...
                {myPanel && (
                  <div className="panel-frame" style={{ maxWidth: 320 }}>
